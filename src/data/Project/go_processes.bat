...
rem //-------------------------------------------------------------------------
set ROOT_FOLDER=%cd%\src\data\Project
set BIN_FOLDER=%ROOT_FOLDER%\64
set OUTPUTS_FOLDER=%ROOT_FOLDER%\working_directory\input
...
set OUTPUT_FILE_NAME=processes_output
...
rem //-------------------------------------------------------------------------
set INPUT_LIBRARY_001=il='!BIN_FOLDER!\intel_process_input.dll'
